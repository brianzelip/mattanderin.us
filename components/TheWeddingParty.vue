    ...
    <div class="container">
      ...
      <ul class="list-reset">
        ...
        <li>
          ...
          <p
            class="h3"
          >Getting distracted here. Long story short: Inkka is the best, and this is the first time since her wedding over ten years ago that the three of us will all be together at the same time. I could cry. I will cry. Okay, now I'm crying.</p>
        </li>
        <li>
          <h2>Charly Bradford</h2>
          <p
            class="h3"
          >Charly "Chucky Lee" Bradford and I met in grad school at UL. We were both having to commute from Pineville to Lafayette every morning at the time, so she opened her car door, said "Welcome to Prius!" and our friendship began. ***Fast forward***We became roommates, living in an apartment behind the Cracker Barrel, right next to a popular vagrant hangout spot littered with empty Bud Light and Redbull cans . Fast forward again to Wellness Wednesdays, a time when we tried to do ab workouts, just about died, decided to go for a walk, and ultimately ended up in my parents' backyard smoking cigarettes.</p>
        </li>
        <li>
          <h2>Jess Hagar</h2>
          <p class="h3"></p>
