...
## 1.2. [v1.5.1] 2020-02-17

- branch: master
- description: Update hard coded data for the render-comments branch to master
...
- description at the end of this feature branch work: actually, I'm rendering comments by adding a step to the build process which gets comments via the netlify api and saves that data to a file, then rebuilds the site which looks for that data file to render out the static comments. On comment form submission, my netlify build hook api is hit to rebuild the site, which goes and gets the comments data, writes to file, then builds the site. Also, the comment submission workflow includes a piece of UI toast and a scroll-to event that takes the user to see the other comments after form submision.
...
- TheCommentsFeed.vue
- Comment.vue
- lambda/submission-created.js: A netlify function that isn't working as expected, see my (so far unanswered) post asking for help on the netlify boards, https://community.netlify.com/t/help-with-event-triggerd-function/9051

### 1.3.3. Updated

- TheComments.vue:
  - add a reset method to reset the form inputs back to empty strings
  - add a piece of toast to the form submission workflow
  - add a scroll-to event to the form submission workflow
  - POST to my netlify build hook upon form submission to auto re-build the site in order to get and render the new comment (this is in place of the netlify function since I can't get that working yet and just want to ship to be done with it and move onto other things)
- main.css
...
## 1.4. [v1.4.1] 2019-12-26

- branch: master
- description: change instances of 'comments of love' text
...
## 1.5. [v1.4.0] 2019-12-26

- branch: comments-form
- description: post wedding work to add a comments page that lets attendees leave a comment; a note will be included about the comments page when the newly weds send out their thank you cards.
  - remove links to RSVP in the nav menu, but keep the page accessible if the url is requested
  - maybe update it?
    - take the form out
    - put up a thank you message using the same heading font

### 1.5.1. Added

- components/TheComments.vue
- components/TheCommentsFail.vue
- components/TheCommentsSuccess.vue
...
- router.js:
  - add comments route
  - swap rsvp success and fail routes for comments
- index.html: Update form markup

## 1.6. [v1.3.5] 2019-12-05

- branch: master
- description: Update afterparty pic

### 1.6.1. Added

- img/location/afterparty.jpg

### 1.6.2. Updated

- TheLocation.vue: swap afterparty pic files

## 1.7. [v1.3.4] 2019-11-09

- branch: linkability
- description: Add id to The Dudes for linkability

### 1.7.1. Updated

- TheWeddingParty.vue: Add id to the The Dudes' section

## 1.8. [v1.3.3] 2019-11-06
...
## 1.9. [v1.3.2] 2019-10-23

### 1.9.1. Meta

- branch: honeymoon-pic
- description: Add pic of island

### 1.9.2. Added

- img/Caye Caulker.jpg
...
## 1.10. [v1.3.1] 2019-10-18

### 1.10.1. Meta

- branch: transp-favicon
- description: make favicon a transparent bg png

### 1.10.2. Updated

- img/favicon/: Replace all existing files generated from https://www.favicon-generator.org/ with the new files generated from the png file w/ transparent background.

## 1.11. [v1.3.0] 2019-10-18
...
## 1.12. [v1.2.5] 2019-10-17

### 1.12.1. Meta

- branch: master
- description: Edit copy and whitepsace

### 1.12.2. Updated

- TheLocation.vue: Add mdashes and simple ...s
- TheRSVP.vue: Add margin-bottom to .sincerely

## 1.13. [v1.2.4] 2019-10-17
...
- README.md: Add content similar to humans.txt

## 1.14. [v1.2.3] 2019-10-17

### 1.14.1. Meta

- branch: master
- description: Break one long paragraph into two in TheOurStory

### 1.14.2. Updated

- TheOurStory.vue: Break the long p into 2 ps

## 1.15. [v1.2.2] 2019-10-16
...
## 1.16. [v1.2.1] 2019-10-16

### 1.16.1. Meta

- branch: whitespace
- description: Add whitespace between paragraphs on TheOurStory.

### 1.16.2. Updated

- ThePage: Update Slide Show title string
- TheOurStory:
  - Bump margin beneath on all `<p>`s and above all `<p>`s except the first
  - Bump margin around `<figures>`s

## 1.17. [v1.2.0] 2019-10-16

### 1.17.1. Meta

- branch: title
- description: Generate unique page `<title>`s

### 1.17.2. Added

- vue-meta: dev dependency
...
- [Changelog](#changelog)
  ...
  - [[v1.5.1] 2020-02-17](#v151-2020-02-17)
    - [Updated](#updated)
  - [[v1.5.0] 2020-02-17](#v150-2020-02-17)
    - [Notes](#notes)
    - [Added](#added)
    - [Updated](#updated)
    - [Deleted](#deleted)
  ...
  - [[v1.4.0] 2019-12-26](#v140-2019-12-26)
    - [Added](#added)
    - [Updated](#updated)
  - [[v1.3.5] 2019-12-05](#v135-2019-12-05)
    - [Added](#added)
    - [Updated](#updated)
  - [[v1.3.4] 2019-11-09](#v134-2019-11-09)
    - [Updated](#updated)
  - [[v1.3.3] 2019-11-06](#v133-2019-11-06)
    - [Meta](#meta)
    - [Updated](#updated)
  - [[v1.3.2] 2019-10-23](#v132-2019-10-23)
    - [Meta](#meta)
    - [Added](#added)
    - [Updated](#updated)
  - [[v1.3.1] 2019-10-18](#v131-2019-10-18)
    - [Meta](#meta)
    - [Updated](#updated)
  ...
  - [[v1.2.5] 2019-10-17](#v125-2019-10-17)
    - [Meta](#meta)
    - [Updated](#updated)
  - [[v1.2.4] 2019-10-17](#v124-2019-10-17)
    - [Meta](#meta)
    - [Updated](#updated)
  - [[v1.2.3] 2019-10-17](#v123-2019-10-17)
    - [Meta](#meta)
    - [Updated](#updated)
